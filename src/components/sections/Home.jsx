...
export const Home = ()=>{
    ...
    className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
           <h1 className="text-5xl font-mono md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right"
           >Hi, I am Rinci Atrey</h1>
           <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto font-mono">
            I am an App Developer with an experience of 2+ years.
           </p>
